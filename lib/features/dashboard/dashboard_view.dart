...
class DashboardView extends ConsumerWidget {
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: trades.isEmpty
                              ...
                              : _buildEquityCurveChart(trades, selectedAccount),
                        ),
                      ],
                    ),
                  ),
  ...
  Widget _buildEquityCurveChart(List<Trade> trades, TradingAccount account) {
    ...
    final double paddingY = diffY > 0 ? diffY * 0.15 : 10.0;
    final double adjustedMinY = minY - paddingY;
    final double adjustedMaxY = maxY + paddingY;
    final double yInterval = diffY > 0 ? (diffY / 4) : 10.0;

    final double xInterval = spots.length > 5 ? (spots.length / 5).ceilToDouble() : 1.0;
